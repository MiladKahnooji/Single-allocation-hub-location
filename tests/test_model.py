...
def test_exact_model_matches_brute_force() -> None:
    expected_objective, expected_assignments = _brute_force(p=2, alpha=0.5, beta=0.5)
    model = build_hub_model(DISTANCE, FLOWS, PROBABILITIES, p=2, alpha=0.5, beta=0.5)
